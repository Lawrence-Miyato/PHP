...
<body>
    ...
    <div class="container">
        <h1>XÓA THÔNG TIN<br>ARE YOU SURE YOU WANT TO DELETE THIS?</h1>
        ...
        <div class="buttons">
            <a href="#" class="btn-delete" onclick="event.preventDefault(); deleteStudent('<?php echo htmlspecialchars($maSV); ?>')">Delete</a>
            ...
            fetch('connect.php?MaSV=' + maSV, {
                ...
                .then(data => {
                    if (data.status === "success") {
                        alert(data.message);
                        window.location.href = 'index.php'; // Chuyển hướng về index.php
                    } else {
                        alert(data.message);
                    }
                })
